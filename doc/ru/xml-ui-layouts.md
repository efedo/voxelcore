...
- `onmouseenter` - lua функция вызываемая при входе курсора в элемент.
- `onmouseleave` - lua функция вызываемая при выходе курсора из элемента.
- `onmouseover` - lua функция вызываемая при наведении курсора на элемент.
- `onmouseout` - lua функция вызываемая при выходе курсора из элемента.
   onmouseenter и onmouseleave не учитывают иерархию элементов.
